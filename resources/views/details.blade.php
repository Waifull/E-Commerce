          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                ...
                @foreach(explode(",", $relatedProduct->images) as $gimg)
                  <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $gimg }}" width="330" height="400"
                    alt="{{ $relatedProduct->name }}" class="pc__img pc__img-second">
                @endforeach
                </a>
                <button
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{ route('shop.product.details', ['product_slug' => $relatedProduct->slug]) }}">{{ $relatedProduct->name }}</a></h6>
